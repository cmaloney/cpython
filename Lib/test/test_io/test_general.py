...
class CIncrementalNewlineDecoderTest(IncrementalNewlineDecoderTest, CTestCase):
    @support.cpython_only
    def test_uninitialized(self):
...
class PyIncrementalNewlineDecoderTest(IncrementalNewlineDecoderTest, PyTestCase):
    pass
